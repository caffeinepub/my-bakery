...
import type { BakerySettings as _BakerySettings, ExternalBlob as _ExternalBlob, MenuItem as _MenuItem, OpeningHour as _OpeningHour, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createMenuItem(arg0: MenuItem): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createMenuItem(await to_candid_MenuItem_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getBakerySettings(): Promise<BakerySettings> {
        if (this.processError) {
            try {
                const result = await this.actor.getBakerySettings();
                return from_candid_BakerySettings_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateBakerySettings(arg0: BakerySettings): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBakerySettings(to_candid_BakerySettings_n24(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMenuItem(arg0: string, arg1: MenuItem): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMenuItem(arg0, await to_candid_MenuItem_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_BakerySettings_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BakerySettings): BakerySettings {
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        heroCtaText: value.heroCtaText,
        aboutTitle: value.aboutTitle,
        email: value.email,
        aboutImageId: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.aboutImageId)),
        aboutBody: value.aboutBody,
        address: value.address,
        openingHours: value.openingHours,
        phone: value.phone,
        heroHeadline: value.heroHeadline,
        heroSubheading: value.heroSubheading
    };
}
...
function to_candid_BakerySettings_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: BakerySettings): _BakerySettings {
...
async function to_candid_MenuItem_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MenuItem): Promise<_MenuItem> {
